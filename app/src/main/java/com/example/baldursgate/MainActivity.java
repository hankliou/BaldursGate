...
public class MainActivity extends Activity implements JoystickView.JoystickListener {
    ...
    // 物品的文字敘述 by周辰陽
    String[] AllItemName = { "蝙蝠長袍", "十字弓", "穢惡之書", "鎖子甲", "聖符", "火球項鍊", "再生戒指", "巨人力量藥劑", "賭徒的骰子", "十呎長棍", "毒藥瓶",
            "發光的石頭", "治療藥水", "速度藥水", "猛擊戒指", "閃電標槍", "項鍊墜" };
    String[] itemword = { "當面臨危險時，你可以使用這個披風變形成一隻蝙蝠，然後逃走。", "當你想要在一個安全距離外投入戰鬥時的好工具。", "只有在你無法獲利時，褻瀆才是一種罪過。",
            "沒什麼能像金屬皮膚一樣保護你自己。", "針的針腳是可以拆卸的，所以你可以有效率的更換神祗的徽記。", "有些問題的最佳解決辦法，就是利用大量的火焰及爆破力。",
            "以木頭製成，這戒指覆蓋著小樹葉，摸起來很溫暖。", "一片山丘巨人的指甲碎片，漂浮在瓶內的清澈液體中。", "儘管它們看起來邪惡，這些骰子讓你覺得你的運氣終於要扭轉了。",
            "當你想要在安全距離外踫觸某些物品時的完美工具。", "在柏德之門，毒藥是最直接的方法去告訴某人，你對他的存在已經厭煩了。", "多麼漂亮的石頭，應該有人會跟你交易它。",
            "當你搖動瓶身，瓶內的紅色液體發出陣陣微光。", "瓶內充滿著黃色及黑色的混合液體，在裡面旋轉著，就像小型的暴風。", "這個鐵戒指有一對公羊頭做為裝飾。", "擁有潛在能量的鋸齒狀標槍，發出陣陣嗡鳴聲。",
            "一條薄薄的金鍊上的愛情紀念品。" };
    String[] itemword2 = { "使用後當你下次受到物理傷害時，做一個速度3+檢定，若你成功，你免疫傷害，當成功使用後棄掉此物品。",
            "使用後下次攻擊以速度進行攻擊（敵人用速度防禦）。在你的速度攻擊中擲 1 個額外的骰(最多 8 顆)。當你使用此武器就不能使用其他武器。", "使用後下次擲骰多擲 2 顆骰子，之後就受到 1 級精神傷害。",
            "每當你受到物理傷害，就減少 1 級傷害。", "取得 1 級知識。當你攻擊給予傷害時，你可以造成額外 1 點精神傷害，若你失去聖符，就失去 1 級知識。",
            "取代正常攻擊，敵人進行速度檢定，擲出4以下受到4點傷害。", "在你的回合結束時，只要有屬性位於最低值，你就可以取得 1 級符合條件的一種屬性。",
            "使用後當你下次要做力量檢定時，你可以使用此道具來額外增加 2 個骰 (最多 8 個骰)，使用後棄掉此卡。",
            "一回合一次，使用後將重擲結果為 0 的所有骰子，並保留第二次擲骰的結果。每個重擲後結果仍然為 0 的骰子，就令你受到 1 級精神傷害。", "使用後下一個事件卡會導致你受傷時，將傷害變為0，並棄掉此物品",
            "使用後當你攻擊造成物理傷害時，令傷害增加[1 顆骰子+1]，並棄掉此卡。", "使用後隨機偷取一件玩家物品，並棄掉此卡。", "使用後 如果你的力量或速度低於初始值，將他們恢復到初始值，並棄掉此卡。",
            "使用後當你下次要做速度檢定時，額外增加 2 個骰 (最多 8 個骰)。並且可以額外多移動 2 步。使用後棄掉此卡。",
            "使用後，下次進行力量攻擊時，你額外擲 1 顆骰(最多 8 個骰)，使用此武器時不能使用其他武器。", "使用後，下次攻擊取代正常攻擊，目標會受到 2 個骰的物理傷害，使用此武器時不能使用其他武器，，並棄掉此卡。",
            "取得 1 級心智，每當你受到精神傷害時，減少 1 級傷害，若你失去項鍊墜，就失去 1 級心智。" };

    // 事件的文字敘述 by周辰陽
    String[] eventname = { "爐邊恐懼", "莫安德的回聲", "惡魔支配", "顱骨鼠群", "爆破符文", "地獄契約", "孤獨的箱子", "吸血鬼迷霧", "腐蛆", "兇猛的大氣元素", "紅巫師",
            "地穴陷阱", "平靜時刻", "鴉閣城迷霧", "迷路之魂", "失去及尋獲", "一個飛天水母出現", "設陷者", "死亡三人眾的考驗", "潛行暗影", "饑餓部族", "綠色史萊姆", "為了眼睛",
            "未來景色", "蹣跚的形體", "散塔林投機者", "黃色黴菌", "鬼火", "謀殺者景象", "女巫的祝福", "乾燥的心臟", "死亡景象", "巴爾的呼喚", "被遺忘的聖物", "洪水" };
    String[] eventword = { "形式古怪的雕像充滿這個區域，這是一群收藏品，還是一個部落呢？", "無預警的，一群觸手從地面竄出並向你揮擊過來。",
            "你發現一個黑曜石雕像立在地面上，當你試著移動它時，觸動了一個惡魔陷阱並試著要支配著你。",
            "一群老鼠從他們的洞穴中竄出並圍繞著你，牠們體形巨大，跳動的大腦擠出頭骨，眼中發出紅光，你發現你的心靈跟一股巨大力量相連結，直達你的大腦及記憶深處。", "一塊羊皮紙陷在泥地裡，不知道上面寫了什麼。",
            "暗影中出現了一個英俊的人並提供協助，他溫和的語氣向你保證他真的是帶著一片好意前來的。", "這裡有個寶箱，樸素而帶有光澤，等待著某人來開啟它。",
            "迷霧向你移動過來，一隻老鼠跑了進去，隨後聽到一聲慘叫，當迷霧移開，只留下一副囓齒動物的外皮。", "某個東西掉到你背上並爬上你的頭，那應該是一種常見的蟲，但這腐蛆可以在幾秒內就鑽入你的腦袋裡！",
            "一個小型的龍捲風經過此區，它把你捲住並試著把你丟到小巷子裡。", "一個頭上覆蓋著刺青的光頭紅長袍女人，從迷霧中慢慢向你靠近，對你說：也許我有你想要的東西。", "有時候，你會在你跌進去時找到一個隱藏的地穴。",
            "你突然發現你孤單一人，現在搜索這個地方應該不會有損失吧？", "迷霧環繞，冷風吹拂，你看到一座糢糊的城堡座落在孤山的山頂上。", "你看見一個矮人幽靈蹣跚的向你靠近，說著：家…離家好遠啊…你能指引我回家的路嗎？",
            "黑杜高告訴你他從岡德神殿中取得的戰利品的藏匿處，毒針終止了他的事業，若你能找到寶藏的話，你就可以任意拿走。", "這是你看過最奇怪的事了－一個有眼睛的水母－漂浮在牆角，並且用帶有尖刺的觸手做出了一些明顯的手勢。",
            "這裡的牆看起來很奇怪，似乎佈滿了軟泥，當你靠近調查時，它又捲曲著將你緊緊纏住。",
            "三個幽魂出現在你面前：一個穿著盔甲的邪惡武士，一個穿著長袍的骷髏法師及一個拿著染血匕首冷笑著的人，你感覺他們在這裡準備考驗你。", "你的影子閃爍並舞動著，慢慢自行融合成一個可怕的人形並撲向你。",
            "老鼠佈滿街道，從下水道的格柵中湧出，像一波浪潮淹沒了路徑上的任何人及任何物品。", "一層厚厚的綠色史萊姆從這個區域的上方滴落。",
            "一些小東西在你視野的邊緣猛衝，你聽到一陣尖叫並往下看，一隻烏鴉飛衝上來，並啄向你的眼睛！", "一個染著血且糢糊的自身影像蹣跚的朝你前來，並說著：我希望我能早點擁有它。在他回到迷霧之前，他給了你一樣東西。",
            "一個醉漢穿過夜色朝你而來，當他靠近時，你看到了你的恐懼，那是一個身體發脹的蹣跚殭屍。", "一名暴徒從暗影中跳出，揮舞著一把匕首，嘶聲的說著：乖乖給我我想要的東西，這樣就沒有人會受傷。",
            "一叢致病的黃色黴菌生長在此，孢子噴出，使你不斷咳嗽。", "閃爍的光芒在前方的暗影中出現，在空中搖曳搖動著，你感覺無法抵抗，跟隨著光芒前進。",
            "你暈眩了一會兒，看到一段過去的景象：一名殺手折斷了受害者的脖子，並把他丟出一棟建築，那軀體墜落著，直到永遠。", "一個穿著破爛長袍的身影蹣跚地走向你，她乳白色的眼睛仔細觀察著，並指著你說道...",
            "你發現一個皺縮且乾燥的心臟被塞進一個黑色木盒裡，當這個心臟以相同的頻率和你的心臟一起跳動時，你開始覺得害怕。", "成群的蟲聚集成一堆，當你靠近時他們就逃開了，只留下一具被吃掉一半的屍體。",
            "你看到一個怪異的頭骨，腳下滿是血池，受折磨的靈魂哭喊的聲音迴盪在你耳中。", "隱藏在角落的牆上，那是正義之神提爾的聖符，也許這裡可以提供你一些幫助。", "那是什麼聲音？" };
    // 匯入角色圖片
    private final int[] guy = {R.drawable.purple_guy, R.drawable.green_guy, R.drawable.blue_guy, R.drawable.red_guy, R.drawable.black_guy, R.drawable.orange_guy};
    // 匯入地圖圖片 by周辰陽
    private final int[] building = { R.drawable.building_fireworks, R.drawable.building_shrine,
            R.drawable.building_hall, R.drawable.building_blood_house, R.drawable.building_mansion,
            R.drawable.building_smithy, R.drawable.building_roost, R.drawable.building_storehouse,
            R.drawable.building_sorcerous_sundries, R.drawable.building_temple, R.drawable.building_trading_post,
            R.drawable.building_warehouse, R.drawable.building_weapon_shop };
    private final int[] catacomb = { R.drawable.catacomb_assassin_run, R.drawable.catacomb_lair,
            R.drawable.catacomb_dusty_cellar, R.drawable.catacomb_flooded_chamber, R.drawable.catacomb_forgotten_cache,
            R.drawable.catacomb_gladiator_pit, R.drawable.catacomb_kobold_hideout, R.drawable.catacomb_rat_nest,
            R.drawable.catacomb_arcane_retreat, R.drawable.catacomb_sacrificial_chamber, R.drawable.catacomb_shrine,
            R.drawable.catacomb_shrine_to_bhaal, R.drawable.catacomb_smuggler_drop, R.drawable.catacomb_vacated_shop,
            R.drawable.catacomb_weapon_shop_basement };
    private final int[] street = { R.drawable.street_ambush_alley, R.drawable.street_beloved_ranger_statue,
            R.drawable.street_cursed_statue, R.drawable.street_dead_end, R.drawable.street_executioner_block,
            R.drawable.street_fountain, R.drawable.street_gray_harbor, R.drawable.street_haunted_alley,
            R.drawable.street_marketplace, R.drawable.street_murder_row, R.drawable.street_rose_portal,
            R.drawable.street_trash_pile, R.drawable.street_watch_post, R.drawable.street_waterfront };
    private final int[] allroom = { R.drawable.building_fireworks, // 0
            R.drawable.building_shrine, R.drawable.building_hall, R.drawable.building_blood_house,
            R.drawable.building_mansion, R.drawable.building_smithy, R.drawable.building_roost,
            R.drawable.building_storehouse, R.drawable.building_sorcerous_sundries, R.drawable.building_temple,
            R.drawable.building_trading_post, R.drawable.building_warehouse, R.drawable.building_weapon_shop,
            R.drawable.catacomb_assassin_run, // 13
            R.drawable.catacomb_lair, R.drawable.catacomb_dusty_cellar, R.drawable.catacomb_flooded_chamber,
            R.drawable.catacomb_forgotten_cache, R.drawable.catacomb_gladiator_pit, R.drawable.catacomb_kobold_hideout,
            R.drawable.catacomb_rat_nest, R.drawable.catacomb_arcane_retreat, R.drawable.catacomb_sacrificial_chamber,
            R.drawable.catacomb_shrine, R.drawable.catacomb_shrine_to_bhaal, R.drawable.catacomb_smuggler_drop,
            R.drawable.catacomb_vacated_shop, R.drawable.catacomb_weapon_shop_basement, R.drawable.street_ambush_alley, // 28
            R.drawable.street_beloved_ranger_statue, R.drawable.street_cursed_statue, R.drawable.street_dead_end,
            R.drawable.street_executioner_block, R.drawable.street_fountain, R.drawable.street_gray_harbor,
            R.drawable.street_haunted_alley, R.drawable.street_marketplace, R.drawable.street_murder_row,
            R.drawable.street_rose_portal, R.drawable.street_trash_pile, R.drawable.street_watch_post,
            R.drawable.street_waterfront }; // 41
    private final String[] allroomdoor = { "RNRY", "YYYR", "NNYR", "RRRR", "RRYN", "YNRN", "RNNN", "RRRR", "NNYR",
            "YNYN", "NNYN", "RYRR", "YYRR", "BNBN", "BBNN", "BBBN", "BNBN", "NBBB", "BBBB", "BNNN", "BNNN", "NBBB",
            "BNBB", "NBNB", "NBBN", "BNNN", "BNBB", "BNBN", "YNYN", "YRYR", "NRYN", "RNNN", "YYYR", "YYYY", "YNNN",
            "YNYN", "NYNR", "RNNR", "YYNY", "NNRN", "NRNR", "YNRN" };
    // 整張地圖目前的房間
    ...
    ImageView[] playerHead;             // 角色頭像
    TextView[][] playerAttribute;       // 角色屬性值
    Button endRound;                    // 回合結束按鈕
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        endRound = findViewById(R.id.roundOver);
        ...
        playerHead = new ImageView[4];
        character = new Character();
        for (int i = 0; i < 4; i++) {
            playerAttributeFrame[i] = new ImageView(this);
            playerHead[i] = new ImageView(this);
        ...
        // 列舉並初始化一些東西(括號只是想它可以折疊)
        {
            ...
            playerHead[0] = findViewById(R.id.onepic);
            playerHead[1] = findViewById(R.id.twopic);
            playerHead[2] = findViewById(R.id.threepic);
            playerHead[3] = findViewById(R.id.fourpic);
        ...
        for (int i = 1; i < 6; i++) {
            ...
            role[i].setImageResource(guy[characterIndex[i]]);
        }
        ...
        switch (id) {
            case R.id.joystick:
                if (myRound) {
                    ...
                    // 移動玩家 (單純顯示)
                    // X && CanPass(plateX, plateY, (playerX[myClientID] + TransDP(x) + 7220) / 600, plateY)
                    ...
                    // Y && CanPass(plateX, plateY, plateX, (playerY[myClientID] + TransDP(y) + 4500) / 600)
                    ...
                    coor.setText("X: " + playerX[myClientID] + " Y: " + playerY[myClientID] + " PX: " + plateX + " PY: "
                            + plateY);
    ...
    void packetMaker() {
        ...
        if(openplate) {
            msgToServer += "1";
            msgToServer += String.format("%02d", openplateposX);
            msgToServer += String.format("%02d", openplateposY);
            msgToServer += String.format("%02d", getnum);
            openplate = false;
        } else {
            msgToServer += "0000000";
        }
        ...
        alert.setPositiveButton("OK", (dialog, which) -> {
            ...
            start.setOnClickListener(v1 -> {
                ...
                for (int i = numberOfPlayer - 1; i <= 3; i++) {
                    ...
                    playerHead[i].setVisibility(View.GONE);
                }
                // 初始化角色們的屬性值
                for (int i = 1, j = 0; i <= numberOfPlayer; i++, j++) { // i 迭代, j 代表屬性欄編號
                    if (i != myClientID) {
                        ...
                        int finalI = i;
                        runOnUiThread(()->{
                            playerHead[finalJ].setImageResource(guy[characterIndex[finalI]]);
                        });
                    } else {
                        j--;
                        ...
                        runOnUiThread(()->{
                            ...
                            myhead.setImageResource(guy[characterIndex[myClientID]]);
                        });
                    }
                }
    ...
    public void newPlate(View view) {
        ...
        blue.setOnClickListener(vBlue -> {
            ...
            // 把旋轉和上下左右出現 by周辰陽
            /*
             * for(int a= 0;a<4;a++) { if (door[plateX][plateY].charAt(a) == 'B') {
             * switch(a) { case 0: up.setEnabled(true); break; case 1:
             * right.setEnabled(true); break; case 2: down.setEnabled(true); break; case 3:
             * left.setEnabled(true); break;
             * 
             * } } }
             */
        ...
        red.setOnClickListener(vRed -> {
            ...
            // 把旋轉和上下左右出現 by周辰陽
            /*
             * for(int a= 0;a<4;a++) { if (door[plateX][plateY].charAt(a) == 'R') {
             * switch(a) { case 0: up.setEnabled(true); break; case 1:
             * right.setEnabled(true); break; case 2: down.setEnabled(true); break; case 3:
             * left.setEnabled(true); break; } } }
             */
        ...
        yellow.setOnClickListener(vYellow -> {
            ...
            // 把旋轉和上下左右出現 by周辰陽
            /*
             * for(int a= 0;a<4;a++) { if (door[plateX][plateY].charAt(a) == 'Y') {
             * switch(a) { case 0: up.setEnabled(true); break; case 1:
             * right.setEnabled(true); break; case 2: down.setEnabled(true); break; case 3:
             * left.setEnabled(true); break; } } }
             */
        ...
        up.setOnClickListener(vUp -> {
            ...
            openplate = true;
            openplateposX = plateX;
            openplateposY = plateY-1;
            packetMaker();
        ...
        left.setOnClickListener(vDown -> {
            ...
            openplate = true;
            openplateposX = plateX-1;
            openplateposY = plateY;
            packetMaker();
...
//                setContentView(v, params1);
    ...
    class StartASocket implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                System.out.println("open inputStreamReader exception : " + e);
            } // 就算拋出例外我也沒辦法處裡
            // 嘗試從接收器擷取訊息
            try {
                while (true) {
                    ...
                    switch (msgFromServer.charAt(0)) {
                        ...
                        case '0': {
                            ...
                            // 顯示玩家人數
                            runOnUiThread(() -> population.setText("玩家人數 : " + numberOfPlayer));
                            break;
                        }
                        case '1': {
                            // 第 1 格代表誰的回合
                            if (msgFromServer.charAt(1) - 48 == myClientID) {
                                ...
                                runOnUiThread(() -> {
                                    endRound.setVisibility(View.GONE);
                                });
                            }
                            // 角色 1~5 的座標 ( 2~11, 12~21, 22~31, 32~41, 42~51)
                            int from = 2, to = 7;
                            for (int i = 1; i < numberOfPlayer + 1; i++) {
                                if (i != myClientID && !myRound) {
                                    ...
                                    role[i].setTranslationX(
                                            role[myClientID].getX() + TransPX(playerX[i] - playerX[myClientID]));
                                    role[i].setTranslationY(
                                            role[myClientID].getY() + TransPX(playerY[i] - playerY[myClientID]));
                                }
                                from += 10;
                                to += 10;
                            }
                        ...
                        case '2': {
                            ...
                            // 26
                            if (msgFromServer.charAt(26) == '1' && !myRound) {
                                int x = Integer.parseInt(msgFromServer.substring(27, 29));
                                int y = Integer.parseInt(msgFromServer.substring(29, 31));
                                int p = Integer.parseInt(msgFromServer.substring(31, 33));
                                maproom[x][y] = p;
                                door[x][y] = allroomdoor[p];
                                runOnUiThread(() -> {
                                    Plate[x][y].setImageResource(allroom[p]);
                                });
                                if (p < 13) buildingopen[p] = 1;
                                else if (p < 28) catacombopen[p - 12] = 1;
                                else streetopen[p - 28] = 1;
                            }
                            break;
                        }
                    }
    ...
    public void Event(int num, TextView context2) {
        ...
        switch (num) {
            case 0:
                GoDice = dice(
                        character.chara[characterIndex[myClientID]].Knowledge[character.chara[characterIndex[myClientID]].currentKnowledge]);
                if (GoDice >= 4) {
            ...
            case 3:
                ...
                if (GoDice >= 4) {
                    ...
                    if (character.chara[characterIndex[myClientID]].currentKnowledge > character.chara[characterIndex[myClientID]].currentSanity)
                        character.chara[characterIndex[myClientID]].currentKnowledge = character.chara[characterIndex[myClientID]].currentKnowledge
                                - dice(1);
                    else
                        character.chara[characterIndex[myClientID]].currentSanity = character.chara[characterIndex[myClientID]].currentSanity
                                - dice(1);
                }
                break;
            case 4:
                ...
                if (GoDice >= 5) {
                    ...
                    if (character.chara[characterIndex[myClientID]].currentSpeed > character.chara[characterIndex[myClientID]].currentMight)
                        character.chara[characterIndex[myClientID]].currentSpeed = character.chara[characterIndex[myClientID]].currentSpeed
                                - dice(1);
                    else
                        character.chara[characterIndex[myClientID]].currentMight = character.chara[characterIndex[myClientID]].currentMight
                                - dice(1);
                }
                break;
            case 5:
                for (int a = 8; a > 0; a--) {
                    if (a == character.chara[characterIndex[myClientID]].currentSpeed) {
                        GoDice = dice(
                                character.chara[characterIndex[myClientID]].Speed[character.chara[characterIndex[myClientID]].currentSpeed]);
                        choose = 1;
                        break;
                    }
                    if (a == character.chara[characterIndex[myClientID]].currentMight) {
                        GoDice = dice(
                                character.chara[characterIndex[myClientID]].Might[character.chara[characterIndex[myClientID]].currentMight]);
                        choose = 2;
                        break;
                    }
                    if (a == character.chara[characterIndex[myClientID]].currentSanity) {
